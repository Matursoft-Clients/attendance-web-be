...
let AnnouncementModule = exports.AnnouncementModule = class AnnouncementModule {
    configure(consumer) {
        consumer
            ...
            .forRoutes({ path: 'announcements', method: common_1.RequestMethod.GET }, { path: 'announcements', method: common_1.RequestMethod.POST }, { path: 'announcements/:slug', method: common_1.RequestMethod.GET }, { path: 'announcements/:slug', method: common_1.RequestMethod.PATCH }, { path: 'announcements/:slug', method: common_1.RequestMethod.DELETE });
    }
};
